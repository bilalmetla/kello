...
let PromotionRepository = class PromotionRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, promotiontypeRepositoryGetter) {
        super(models_1.Promotion, dataSource);
        this.promotiontypeRepositoryGetter = promotiontypeRepositoryGetter;
...
PromotionRepository = __decorate([
    __param(0, core_1.inject('datasources.killo')), __param(1, repository_1.repository.getter('PromotiontypeRepository')),
