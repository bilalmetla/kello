...
let ProductsRepository = class ProductsRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, unitsRepositoryGetter, producttypesRepositoryGetter) {
        super(models_1.Products, dataSource);
        this.unitsRepositoryGetter = unitsRepositoryGetter;
        this.producttypesRepositoryGetter = producttypesRepositoryGetter;
...
ProductsRepository = __decorate([
    __param(0, core_1.inject('datasources.killo')), __param(1, repository_1.repository.getter('UnitsRepository')), __param(2, repository_1.repository.getter('ProducttypesRepository')),
