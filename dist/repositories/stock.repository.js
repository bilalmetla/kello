...
let StockRepository = class StockRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, productsRepositoryGetter, unitsRepositoryGetter) {
...
StockRepository = __decorate([
    __param(0, core_1.inject('datasources.killo')), __param(1, repository_1.repository.getter('ProductsRepository')), __param(2, repository_1.repository.getter('UnitsRepository')),
