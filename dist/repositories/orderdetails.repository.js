...
let OrderdetailsRepository = class OrderdetailsRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, unitsRepositoryGetter) {
        super(models_1.Orderdetails, dataSource);
...
OrderdetailsRepository = __decorate([
    __param(0, core_1.inject('datasources.killo')), __param(1, repository_1.repository.getter('UnitsRepository')),
