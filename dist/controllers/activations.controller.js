...
let ActivationsController = class ActivationsController {
    ...
    updateById(id, activations) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.activationsRepository.updateById(id, activations);
        });
    }
    replaceById(id, activations) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.activationsRepository.replaceById(id, activations);
        });
    }
    deleteById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.activationsRepository.deleteById(id);
        });
    }
};
__decorate([
    rest_1.post('/activations', {
        responses: {
            '200': {
                ...
                content: { 'application/json': { schema: rest_1.getModelSchemaRef(models_1.Activations) } },
            },
        },
    }),
...
__decorate([
    ...
    __param(0, rest_1.param.query.object('where', rest_1.getWhereSchemaFor(models_1.Activations))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
            ...
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: {
                            type: 'array',
                            items: rest_1.getModelSchemaRef(models_1.Activations, { includeRelations: true }),
                        },
                    },
                },
            },
    ...
    __param(0, rest_1.param.query.object('filter', rest_1.getFilterSchemaFor(models_1.Activations))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Activations, { partial: true }),
            },
        },
    })),
    __param(1, rest_1.param.query.object('where', rest_1.getWhereSchemaFor(models_1.Activations))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.Activations, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    rest_1.get('/activations/{id}', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: rest_1.getModelSchemaRef(models_1.Activations, { includeRelations: true }),
                    },
                },
            },
        },
    ...
    __param(1, rest_1.param.query.object('filter', rest_1.getFilterSchemaFor(models_1.Activations))),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, models_1.Activations]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ActivationsController.prototype, "deleteById", null);
ActivationsController = __decorate([
    __param(0, repository_1.repository(repositories_1.ActivationsRepository)),
    __metadata("design:paramtypes", [repositories_1.ActivationsRepository])
], ActivationsController);
exports.ActivationsController = ActivationsController;
//# sourceMappingURL=activations.controller.js.map