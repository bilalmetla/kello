...
var ShoppingComponent = /** @class */ (function () {
    ...
    ShoppingComponent.prototype.del = function (pid) {
        if (this.selectedProduct[pid]) {
            if (this.selectedProduct[pid].product_quality == 0) {
                ...
                delete this.selectedProduct[pid];
                return;
            }
    ...
    ShoppingComponent.prototype.save = function () {
        ...
        this.customer = {};
        this.shoppingService.save(this.order).subscribe(function (res_order) {
            if (res_order.error) {
                _this.customer = JSON.parse(JSON.stringify(_this.order.web_customer));
                return;
            }
            //  console.log('in side of save', res_order);
